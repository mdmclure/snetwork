...
om.tempid.TempId.cljs$lang$ctorPrWriter = (function (this__19482__auto__,writer__19483__auto__,opt__19484__auto__){
return cljs.core._write.call(null,writer__19483__auto__,"om.tempid/TempId");
});
...
var args31804 = [];
var len__19984__auto___31807 = arguments.length;
var i__19985__auto___31808 = (0);
while(true){
if((i__19985__auto___31808 < len__19984__auto___31807)){
args31804.push((arguments[i__19985__auto___31808]));

var G__31809 = (i__19985__auto___31808 + (1));
i__19985__auto___31808 = G__31809;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args31804.length)].join('')));
