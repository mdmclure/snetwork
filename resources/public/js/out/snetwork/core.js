...
var x35554_35564 = snetwork.core.AppRoot.prototype;
x35554_35564.componentWillUpdate = ((function (x35554_35564){
...
var ident__30495__auto___35565 = om.next.ident.call(null,this__30491__auto__,om.next.props.call(null,this__30491__auto__));
var next_ident__30496__auto___35566 = om.next.ident.call(null,this__30491__auto__,om.next._next_props.call(null,next_props__30492__auto__,this__30491__auto__));
if(cljs.core.not_EQ_.call(null,ident__30495__auto___35565,next_ident__30496__auto___35566)){
var idxr__30497__auto___35567 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__30491__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__30497__auto___35567 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__30497__auto___35567),((function (idxr__30497__auto___35567,ident__30495__auto___35565,next_ident__30496__auto___35566,this__30491__auto__,x35554_35564){
return (function (indexes__30498__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__30498__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__30495__auto___35565], null),cljs.core.disj,this__30491__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__30496__auto___35566], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__30491__auto__);
});})(idxr__30497__auto___35567,ident__30495__auto___35565,next_ident__30496__auto___35566,this__30491__auto__,x35554_35564))
);
}
} else {
}
...
x35554_35564.shouldComponentUpdate = ((function (x35554_35564){
return (function (next_props__30492__auto__,next_state__30493__auto__){
var this__30491__auto__ = this;
...
var next_props__30492__auto____$2 = (function (){var G__35556 = next_props__30492__auto____$1;
if((next_props__30492__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__35556);
} else {
return G__35556;
}
})();
...
x35554_35564.componentWillUnmount = ((function (x35554_35564){
return (function (){
var this__30491__auto__ = this;
...
x35554_35564.componentDidUpdate = ((function (x35554_35564){
...
x35554_35564.isMounted = ((function (x35554_35564){
return (function (){
var this__30491__auto__ = this;
...
x35554_35564.componentWillMount = ((function (x35554_35564){
return (function (){
var this__30491__auto__ = this;
...
x35554_35564.render = ((function (x35554_35564){
return (function (){
var this__30490__auto__ = this;
var this$ = this__30490__auto__;
var _STAR_reconciler_STAR_35557 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_35558 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_35559 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_35560 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_35561 = om.next._STAR_parent_STAR_;
...
return cljs_react_material_ui.core.mui_theme_provider.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"mui-theme","mui-theme",-164636823),cljs_react_material_ui.core.get_mui_theme.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"palette","palette",-456203511),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"primary1-color","primary1-color",-450634374),cljs_react_material_ui.core.color.call(null,new cljs.core.Keyword(null,"deep-orange-a100","deep-orange-a100",-560524699))], null),new cljs.core.Keyword(null,"raised-button","raised-button",1120646461),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"primary-text-color","primary-text-color",-1255467826),cljs_react_material_ui.core.color.call(null,new cljs.core.Keyword(null,"light-black","light-black",1983033322)),new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(200)], null)], null))], null),React.DOM.div(({"className": "container"}),om.util.force_children.call(null,snetwork.example_grid.example_grid.call(null,examples)),om.util.force_children.call(null,snetwork.space_view.space_view.call(null,space))));
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_35561;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_35560;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_35559;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_35558;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_35557;
}});})(x35554_35564))
;
...
var x35562_35568 = snetwork.core.AppRoot;
x35562_35568.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;

x35562_35568.om$next$IQuery$query$arity$1 = ((function (x35562_35568){
...
var x35563_35569 = snetwork.core.AppRoot.prototype;
x35563_35569.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;

x35563_35569.om$next$IQuery$query$arity$1 = ((function (x35563_35569){
return (function (this$){
var this$__$1 = this;
return cljs.core.vec.call(null,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(function (){var x__22462__auto__ = cljs.core.apply.call(null,cljs.core.array_map,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Keyword(null,"examples","examples",-473712556)),(function (){var x__22462__auto__ = om.next.get_query.call(null,snetwork.example_grid.ExampleGrid);
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__22462__auto__);
...
//# sourceMappingURL=core.js.map?rel=1490684074573